...
public class RegistroConsumo {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE,  generator = "consumo_generator")
    @SequenceGenerator(name = "consumo_generator", sequenceName = "consumo_seq", allocationSize = 1)
