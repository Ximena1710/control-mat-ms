...
public class MaterialInsumoController {
	...
	public  ResponseEntity<String> saveMaterial(@RequestBody MaterialInsumoDTO materialInsumo) throws JsonProcessingException {
		 return  new ResponseEntity<>(materialInsulmoService.saveAndUpdate(materialInsumo), HttpStatus.OK);

	}
	
	@PutMapping(path = "/update", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String>  updateMaterial(@RequestBody MaterialInsumoDTO materialInsumo) throws JsonProcessingException {
	 ...
	 @DeleteMapping("/delete")
	    public ResponseEntity<String> deleteMaterial(@RequestBody MaterialInsumoDTO materialInsumoDTO) throws JsonProcessingException {		 
